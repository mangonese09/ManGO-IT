...
const UA = 'ManGO-IT/0.33.0 (+https://it.mangonese.dev; miconsig@gmail.com)';
...
// ── ROUTES ──
const routes = {
  'GET /api/health': async () => ({ ok: true, version: '0.33.0', romeTime: romeNowString(), feedHorizon: feedHorizon(), viaggiaTreno: vtSilence(vtStats), upstreamRequests: dayCounts }),
